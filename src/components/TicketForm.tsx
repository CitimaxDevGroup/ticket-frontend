            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select onValueChange={field.onChange} value={field.value} defaultValue="">
                  <FormControl>
                    <SelectTrigger>
                      <SelectValue placeholder="Please select your company name" />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Please provide brief description of your issue" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
            ...
            render={({ field }) => (
              <FormItem>
                ...
                >
                  <FormControl>
                    <SelectTrigger>
                      <SelectValue placeholder="Please select the issue type" />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
